...
import com.example.practice2.Constants.Companion.RETARDANT_LOWER_LIMIT
import com.example.practice2.Constants.Companion.RETARDANT_UPPER_LIMIT
...
data class CheckinOut(
    ...
    fun isRetardant(currentSchedule: Schedule,
                    permissions: List<Permissions>): Boolean {
